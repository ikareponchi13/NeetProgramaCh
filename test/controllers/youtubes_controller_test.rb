...
class YoutubesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create youtube" do
    assert_difference('Youtube.count') do
      post youtubes_url, params: { youtube: { body: @youtube.body, youtube_url: @youtube.youtube_url } }
    end
  ...
  test "should update youtube" do
    patch youtube_url(@youtube), params: { youtube: { body: @youtube.body, youtube_url: @youtube.youtube_url } }
